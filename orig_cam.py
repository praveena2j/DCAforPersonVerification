...
from predict_layer import PredictLayer
...
class CAM(nn.Module):
    def __init__(self):
        ...
        self.coattn = DCNLayer(512, 192, 2, 0.6)

        self.audio_extract = LSTM(192, 192, 2, 0.1, residual_embeddings=True)
        ...
        self.predict = PredictLayer(512, 192, 1150, 0.3)
